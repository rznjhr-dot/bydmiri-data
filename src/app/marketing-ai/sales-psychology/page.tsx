    ...
    <div className="min-h-screen">
      <section className="page-header">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-[var(--color-text-primary)] tracking-tight">Sales Psychology Engine</h1>
          <p className="text-sm text-[var(--color-text-tertiary)] mt-1">Map customer personas to marketing strategy, tone, and buying triggers</p>
        </div>
      </section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {matchedStrategies.map((s) => (
                    <div key={s.id} className="card">
                      <h3 className="font-semibold text-[var(--color-text-primary)] text-sm mb-0.5">{s.name}</h3>
