...
const modules: ModuleInfo[] = [
  {
    ...
    description: "Chief Marketing Officer — orchestrates all modules, decides strategy",
    href: "/marketing-ai/marketing-brain",
    status: "active",
    capabilities: ["Decide campaign", "Set priority", "Assign modules", "Review outcomes"],
    icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
  },
  {
    id: "intelligence",
    title: "Marketing Intelligence",
    description: "Marketing Director — analyses events, festive calendars, opportunities",
    href: "/marketing-ai/intelligence",
    status: "active",
    capabilities: ["Track events", "Suggest campaigns", "Recommend audience", "Emotional direction"],
  ...
  },
  {
    ...
    href: "/marketing-ai/campaign-generator",
    status: "active",
    capabilities: ["Full campaign suite", "Multi-platform", "Creative brief", "Timeline"],
    icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",
  },
  {
    id: "prompt-builder",
    title: "Prompt Builder",
    description: "Crafts precision prompts for GPT Image, Midjourney, Flux, Veo, Runway",
    href: "/marketing-ai/prompt-builder",
    status: "active",
    capabilities: ["6 AI tools", "Modular templates", "Enhancers", "Future-ready"],
    icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4",
  },
  {
    id: "creative-director",
    title: "Creative Director",
    description: "Reviews creative quality across 9 weighted scoring criteria",
    href: "/marketing-ai/creative-director",
    status: "active",
    capabilities: ["Score typography", "Evaluate composition", "Brand consistency", "Improvement tips"],
    icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z",
  },
  {
    id: "brand-guardian",
    title: "Brand Guardian",
    description: "Protects BYD branding — rejects violations across 12 compliance rules",
    href: "/marketing-ai/brand-guardian",
    status: "active",
    capabilities: ["Logo compliance", "Colour check", "Cultural review", "AI content review"],
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
  },
  {
    id: "sales-psychology",
    title: "Sales Psychology",
    description: "Maps 9 customer personas to marketing strategy, tone, and triggers",
    href: "/marketing-ai/sales-psychology",
    status: "active",
    capabilities: ["9 personas", "Buying triggers", "Tone selection", "Visual direction"],
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
  },
  {
    id: "content-calendar",
    title: "Content Calendar AI",
    description: "Auto-detects celebrations, holidays, and monthly opportunities",
    href: "/marketing-ai/content-calendar",
    status: "active",
    capabilities: ["Today detection", "Upcoming events", "School holidays", "Payday tracking"],
    icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
  },
  {
    id: "seasonal-opportunities",
    title: "Seasonal Opportunities",
    description: "Monitors economic, weather, travel, and seasonal signals for campaign ideas",
    href: "/marketing-ai/seasonal-opportunities",
    status: "active",
    capabilities: ["Fuel price tracking", "Travel seasons", "Roadshow sync", "Year-end planning"],
...
const quickStats = [
  ...
  { label: "Active", value: modules.filter((m) => m.status === "active").length.toString() },
      ...
      <main id="main-content" className="page-enter max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {modules.map((mod) => (
              <Link key={mod.id} href={mod.href} className="card card-interactive group relative overflow-hidden">
                <div className="flex items-start gap-3">
                ...
                <div className="mt-3 pt-2.5 border-t border-neutral-100 flex items-center justify-between">
                  ...
                  <span className={`w-1.5 h-1.5 rounded-full ${mod.status === "active" ? "bg-green-500" : "bg-amber-400"}`} />
                </div>
              </Link>
            ))}
          </div>
