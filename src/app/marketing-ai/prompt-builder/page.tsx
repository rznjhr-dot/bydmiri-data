    ...
    <div className="min-h-screen">
      <section className="page-header">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-[var(--color-text-primary)] tracking-tight">Prompt Builder</h1>
          <p className="text-sm text-[var(--color-text-tertiary)] mt-1">Craft precision prompts for GPT Image, Midjourney, Flux, Stable Diffusion, Veo, and Runway</p>
        </div>
      </section>
          ...
          <>
            ...
            <div className="card border-l-4 border-l-accent">
              ...
              <div className="mt-3 pt-3 border-t border-[var(--color-border-primary)]">
                <h3 className="text-xs font-semibold text-[var(--color-text-secondary)] mb-1 uppercase tracking-wider">Template Prefix</h3>
                <pre className="bg-[var(--color-bg-tertiary)] border border-[var(--color-border-primary)]/60 rounded-lg p-2.5 text-xs font-mono text-[var(--color-text-secondary)] whitespace-pre-wrap">
                  {tool.templatePrefix}
                </pre>
              </div>
            </div>
