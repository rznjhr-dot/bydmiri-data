      ...
      <section className="page-header">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-[var(--color-text-primary)] tracking-tight">Saved Prompts</h1>
              <p className="text-sm text-[var(--color-text-tertiary)] mt-0.5">Your saved prompt collection — stored locally in your browser</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl border border-[var(--color-border-primary)] bg-white text-sm text-[var(--color-text-primary)] placeholder-[var(--color-text-tertiary)] focus:outline-none focus:ring-4 focus:ring-purple-500/15 focus:border-purple-400 transition-all shadow-[var(--shadow-subtle)]"
            />
          </div>
        </div>
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-16">
            <div className="w-16 h-16 rounded-2xl bg-[var(--color-bg-tertiary)] flex items-center justify-center mx-auto mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-text-tertiary)]"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>
            </div>
            <p className="text-sm text-[var(--color-text-tertiary)] mb-1">No saved prompts yet</p>
            <p className="text-xs text-[var(--color-text-tertiary)]">Build your first prompt in the Prompt Builder and save it here</p>
          </div>
        ) : (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg text-[var(--color-text-tertiary)] hover:text-red-500 hover:bg-red-50 transition-all cursor-pointer"
                      title="Delete"
                    >
